		...
		<view variant="text" class="card">
			<uni-forms class="form" :modelValue="formData" 
				...
				<uni-row class="form-row">
					<uni-col :span="24">
						<uni-forms-item required name="verify" :label="$t('LABEL_SEND_VERIFY')" class="form-item" label-width="100vw">
							<uni-easyinput class="input" type="text" v-model="formData.verify"/>
						</uni-forms-item>
					</uni-col>
				</uni-row>
				<uni-row class="form-row">
